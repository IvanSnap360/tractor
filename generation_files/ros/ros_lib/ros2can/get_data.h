#ifndef _ROS_SERVICE_get_data_h
#define _ROS_SERVICE_get_data_h
#include <stdint.h>
#include <string.h>
#include <stdlib.h>
#include "ros/msg.h"
...
static const char GET_DATA[] = "ros2can/get_data";

  class get_dataRequest : public ros::Msg
  {
    public:
    ...
    virtual const char * getType() override { return GET_DATA; };
    virtual const char * getMD5() override { return "0dba762d409c9ac12516987f0927c77c"; };

  };

  class get_dataResponse : public ros::Msg
  {
    public:
      typedef int8_t _data_1_type;
      _data_1_type data_1;
      typedef int8_t _data_2_type;
      _data_2_type data_2;
      typedef int8_t _data_3_type;
      _data_3_type data_3;
      typedef int8_t _data_4_type;
      _data_4_type data_4;
      typedef int8_t _data_5_type;
      _data_5_type data_5;
      typedef int8_t _data_6_type;
      _data_6_type data_6;
      typedef int8_t _data_7_type;
      _data_7_type data_7;
      typedef int8_t _data_8_type;
      _data_8_type data_8;
    ...
    virtual int deserialize(unsigned char *inbuffer) override
    {
      ...
      u_data_1.base = 0;
      u_data_1.base |= ((uint8_t) (*(inbuffer + offset + 0))) << (8 * 0);
      ...
      u_data_2.base = 0;
      u_data_2.base |= ((uint8_t) (*(inbuffer + offset + 0))) << (8 * 0);
      ...
      u_data_3.base = 0;
      u_data_3.base |= ((uint8_t) (*(inbuffer + offset + 0))) << (8 * 0);
      ...
      u_data_4.base = 0;
      u_data_4.base |= ((uint8_t) (*(inbuffer + offset + 0))) << (8 * 0);
      ...
      u_data_5.base = 0;
      u_data_5.base |= ((uint8_t) (*(inbuffer + offset + 0))) << (8 * 0);
      ...
      u_data_6.base = 0;
      u_data_6.base |= ((uint8_t) (*(inbuffer + offset + 0))) << (8 * 0);
      ...
      u_data_7.base = 0;
      u_data_7.base |= ((uint8_t) (*(inbuffer + offset + 0))) << (8 * 0);
      ...
      u_data_8.base = 0;
      u_data_8.base |= ((uint8_t) (*(inbuffer + offset + 0))) << (8 * 0);
    ...
    virtual const char * getType() override { return GET_DATA; };
    virtual const char * getMD5() override { return "f55a0ec4d33b9e7c7f6e1a56c636366d"; };

  };

  class get_data {
    public:
    typedef get_dataRequest Request;
    typedef get_dataResponse Response;
  };

...
cp default_can_publisher.ino ../../../arduino_sketches/"$program_name"/
...
mv ../../../arduino_sketches/"$program_name"/default_can_publisher.ino ../../../arduino_sketches/"$program_name"/"$program_name".ino
